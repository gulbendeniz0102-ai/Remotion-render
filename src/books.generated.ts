...
import cfg_the_aeneid from '../books/the-aeneid/config.vox.json';
import meta_the_aeneid from '../books/the-aeneid/youtube-meta.json';
...
import ant_meta_paradise_lost from '../books/paradise-lost/youtube-meta.json';
...
import ant_speaker_for_the_dead from '../books/speaker-for-the-dead/config.antidote.json';
import ant_meta_speaker_for_the_dead from '../books/speaker-for-the-dead/youtube-meta.json';
...
export const BOOK_PALETTES: Record<string, Palette> = {
  ...
  'speaker-for-the-dead': { paper: '#E7E7D8', ink: '#121A17', red: '#4E7A3A', gold: '#C87F3C', captionHighlight: '#E8C66A' },
  'sway': { paper: '#E4E1E8', ink: '#1C1822', red: '#7C3AED', gold: '#D9A13C' },
  'the-aeneid': { paper: '#EDE7DB', ink: '#161219', red: '#7A2B46', gold: '#B0793A' },
...
export const BOOKS: BookEntry[] = [
  ...
  },
  {
    slug: 'the-aeneid',
    engine: 'vox',
    config: cfg_the_aeneid as any,
    meta: meta_the_aeneid as any,
  },
  {
    slug: 'the-chosen',
    engine: 'vox',
...
export const ANTIDOTE_BOOKS: AntidoteBookEntry[] = [
  ...
  },
  {
    ...
    meta: ant_meta_paradise_lost as any,
  },
  {
    slug: 'psychology-of-money',
    engine: 'vox',
  ...
  },
  {
    ...
    engine: 'antidote',
    config: ant_speaker_for_the_dead as any,
    meta: ant_meta_speaker_for_the_dead as any,
  },
  {
